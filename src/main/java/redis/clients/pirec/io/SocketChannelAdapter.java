...
public class SocketChannelAdapter implements SocketAdapter {
    ...
    public CompletableFuture<Void> connect(SocketAddress remote) {
        ...
        return NioFutures.acceptAsync(socket::connect, remote);
    }

    @Override
    public CompletableFuture<Integer> write(ByteBuffer src) {
        return NioFutures.applyAsync(socket::write, src);
    }

    @Override
    public CompletableFuture<Integer> read(ByteBuffer dst) {
        return NioFutures.applyAsync(socket::read, dst);
    }
}
